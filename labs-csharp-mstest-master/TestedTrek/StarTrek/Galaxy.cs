...
public class Galaxy {
    ...
    public bool IsPhaser => Parameter("command").Equals("phaser");

    public bool IsPhoton => Parameter("command").Equals("photon");

    public int Amount => int.Parse(Parameter("amount"));

    public Klingon Target => (Klingon)Variable("target");
}
